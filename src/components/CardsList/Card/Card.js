...
export function Card({add,url, created, likes, handlePressHeart, profile, name, ava, description, open, id, getImageObj, pressed, setPressed, setLikedId, likePhoto, isLiked, isAuth}) {
  return (
