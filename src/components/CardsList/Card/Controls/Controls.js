...
export function Controls({likes, pressed, setPressed, setLikedId, likePhoto, id, isLiked, handlePressHeart, isAuth}) {

  return (
    <div className={styles.controls}>
      <div className={styles.likesCounter}>
        <span className={styles.likesValue}>{likes}</span>
        <button className={styles.button} onClick={()=>isAuth ? handlePressHeart(id):false}>
